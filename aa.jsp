...
<% if(request.getParameter("reg")!=null){
	  out.println("<script>alert('Registered Successfully')</script>");
            ...
            <div class="col-md-9 agileinfo-contact-main-address">
                <h4 class="w3ls-inner-title">AA Login </h4>
               ...
               <!-- <div class="list_agileits_w3layouts">
                ...
                <div class="agileits-main-right">
                    ...
                    <form action="aaCheck.jsp" method="post" class="agile_form">
					 ...
					 <!-- <a href="aaregister.jsp"><img src="images/register-icon.gif" width="200" height="80" border="0" alt=""></a> -->
		        </div>
		        <div class="clearfix">	</div>
	        </div>		
         </div>
