		...
		<div class="container-fluid">
			<div class="header-grid">
				<div class="header-grid-left">
					<ul>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:bharathparsam@gmailcom">bharathparsam@gmail.com</a></li>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav">
								...
								<li><a href="sysint.jsp">System Initialization</a></li>
								<li><a href="ownerlist.jsp">Owner's</a></li>
								<li><a href="Userslist.jsp">User's</a></li>
								<li><a href="aalist.jsp">AA's</a></li>
								<li><a href="aareqsk.jsp">REQ_SK</a></li>
								<li><a href="audit.jsp">Auditing</a></li>
